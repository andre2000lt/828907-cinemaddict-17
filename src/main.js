...
filmsListPresenter.init(siteContent.getElement());
topListPresenter.init(siteContent.getElement());
mostCommentedListPresenter.init(siteContent.getElement());
statsPresenter.init(statsWrapperElement);
detailsPresenter.init(siteFooterElement);
